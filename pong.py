...
raquete_img = pygame.Surface((10, 50))  # Criando uma raquete de 10x100 pixels
raquete_img.fill(AMARELO)  # Cor da raquete (azul)

bola_img = pygame.Surface((10, 10))  # Criando a bola com 20x20 pixels
bola_img.fill(AMARELO)  # Cor da bola (vermelha)
...
velocidade_bola_x, velocidade_bola_y = 2, 2
...
def desenhar():
    ...
    # Desenha a pontuação
    pontos_texto = fonte.render(f'{pontos_player1} - {pontos_player2}', True, AMARELO)
